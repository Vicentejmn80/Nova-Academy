  ...
  <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
    <nav>
      ...
      <ol class="flex flex-wrap pt-1 bg-transparent rounded-lg">
        <li class="{{ (false ? 'pl-2' : '') }} leading-normal text-size-sm">
          <a class="opacity-50 text-slate-700" href="javascript:;">Pages</a>
        </li>
        <li
          class="text-size-sm pl-2 capitalize leading-normal text-slate-700 {{ (false ? 'before:float-right before:pl-2' : 'before:float-left before:pr-2') }} before:text-gray-600 before:content-['/']"
    ...
    <div
      class="flex items-center mt-2 grow sm:mt-0 {{ (false ? '' : 'sm:mr-6') }}md:mr-0 lg:flex lg:basis-auto">
      ...
      <div class="flex items-center md:ml-auto md:pr-4">
        ...
        <div class="ml-2 relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease-soft">
          <span
            class="text-size-sm ease-soft leading-5.6 absolute z-50 {{ (false ? '-mr-px border-l-0 rounded-tl-none rounded-bl-none' : '-ml-px border-r-0 rounded-tr-none rounded-br-none') }} flex h-full items-center whitespace-nowrap rounded-lg border border-transparent bg-transparent py-2 px-2.5 text-center font-normal text-slate-500 transition-all">
            <i class="fas fa-search"></i>
          </span>
          <input type="text"
            class="{{ (false ? 'pr-8.75 -mr-px pl-0' : 'pl-8.75 -ml-px pr-3') }} text-size-sm focus:shadow-soft-primary-outline ease-soft w-1/100 leading-5.6 relative block min-w-0 flex-auto rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 text-gray-700 transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
            placeholder="Type here..." />
        </div>
      </div>
      <ul
        class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full {{ (false ? 'pr-10 ml-0 mr-auto' : '') }}">

        <!-- online builder btn  -->
        {{-- <li class="flex items-center">
          <a class="inline-block px-8 py-2 mb-0 {{ (false ? 'ml-4' : 'mr-4') }}  font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro border-fuchsia-500 ease-soft-in text-size-xs hover:scale-102 active:shadow-soft-xs text-fuchsia-500 hover:border-fuchsia-500 active:bg-fuchsia-500 active:hover:text-fuchsia-500 hover:text-fuchsia-500 tracking-tight-soft hover:bg-transparent hover:opacity-75 hover:shadow-none active:text-white active:hover:bg-transparent"
            target="_blank"
        ...
        <li class="flex items-center {{ (false ? 'pr-4' : 'pl-4') }} xl:hidden">
        ...
        <li class="relative flex items-center {{ (false ? 'pl-2' : 'pr-2') }}">
            ...
            <ul dropdown-menu
                  ...
                  <div class="flex py-1">
                    <div class="my-auto">
                      <img src="assets/img/team-2.jpg"
                        class="inline-flex items-center justify-center {{ (false ? 'ml-4' : 'mr-4') }} text-white text-size-sm h-9 w-9 max-w-none rounded-xl" />
                    </div>
                    <div class="flex flex-col justify-center">
                      <h6 class="mb-1 font-normal leading-normal text-size-sm"><span class="font-semibold">New
                          message</span> from Laur</h6>
                      <p
                        class="mb-0 {{ (false ? 'ml-auto' : '') }} leading-tight text-size-xs text-slate-400">
                        <i class="{{ (false ? 'ml-1' : 'mr-1') }} fa fa-clock"></i>
                        13 minutes ago
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="flex py-1">
                    <div class="my-auto">
                      <img src="assets/img/small-logos/logo-spotify.svg"
                        class="inline-flex items-center justify-center {{ (false ? 'ml-4' : 'mr-4') }} text-white text-size-sm bg-gradient-dark-gray h-9 w-9 max-w-none rounded-xl" />
                    </div>
                    <div class="flex flex-col justify-center">
                      <h6 class="mb-1 font-normal leading-normal text-size-sm"><span class="font-semibold">New
              ...
              <li class="relative">
                <a class="ease-soft py-1.2 clear-both block w-full whitespace-nowrap rounded-lg px-4 transition-colors duration-300 hover:bg-gray-200 hover:text-slate-700"
                  ...
                  <div class="flex py-1">
                    <div
                      class="inline-flex items-center justify-center my-auto {{ (false ? 'ml-4' : 'mr-4') }} text-white transition-all duration-200 ease-nav-brand text-size-sm bg-gradient-slate h-9 w-9 rounded-xl">
