...
<aside
  ...
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 
    ...
    {{ (false ? 'xl:right-0 mr-4 translate-x-full' : 'xl:left-0 ml-4 -translate-x-full ') }} xl:translate-x-0 xl:bg-transparent
    ">
    ...
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ url('') }}" target="_blank">
        ...
        <span
          class="{{ (false ? 'mr-1' : 'ml-1') }} font-semibold transition-all duration-200 ease-nav-brand">Soft
          UI Dashboard</span>
      </a>
    </div>

    <hr
      class="h-px mt-0 bg-transparent {{ (false ? 'bg-gradient-horizontal-dark' : 'via-black/40 bg-gradient-to-r from-transparent to-transparent') }} " />
      ...
      <ul class="flex flex-col pl-0 mb-0">
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Dashboard</span>
          </a>
        </li>

        <li class="w-full mt-4">
          <h6
            class="{{ (false ? 'pr-6 mr-2' : 'pl-6 ml-2') }} font-bold leading-tight uppercase text-size-xs opacity-60">
            Laravel examples</h6>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">User
              Profile</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Tables</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Billing</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (false ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('virtual-reality') }}">
            <div
              class="{{ (false ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                  ...
                  <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(603.000000, 0.000000)">
                        <path class="{{ (false ? '' : 'fill-slate-800') }}"
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Virtual
              Reality</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
                  ...
                  <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(304.000000, 151.000000)">
                        <polygon class="{{ (false ? '' : 'fill-slate-800') }}"
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">RTL</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Profile</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <span
              class="{{ (false ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Sign
              In</span>
          </a>
        </li>
      ...
      <div
        ...
        <div class="relative z-20 flex-auto w-full p-4 text-left text-white">
          ...
          <div class="transition-all duration-200 ease-nav-brand">
            <h6 class="mb-0 text-white {{ (false ? 'text-right' : '') }}">Need help?</h6>
            <p
              class="mt-0 mb-4 font-semibold leading-tight text-size-xs {{ (false ? 'text-right' : '') }}">
